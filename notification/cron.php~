...
defined('MOODLE_INTERNAL') || die('SAI');

require_once(dirname(__FILE__) . '/../../config.php');
require_once($CFG->dirroot . '/mod/quiz/locallib.php');

$config = get_config('local_auto_processattempt');

if((time() - $config->lastcron) <  $CFG->local_auto_processattempt_cron) return 0;
...
set_config('lastcron', time(), 'local_auto_processattempt');
